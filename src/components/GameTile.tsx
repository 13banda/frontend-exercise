...
export function GameTile({ tile, onFlip, disabled = false }: GameTileProps) {
  ...
  return (
    <div
      className={`
        relative aspect-square cursor-pointer transition-all duration-300 transform hover:scale-105 w-full h-full max-w-32 max-h-32
    ...
    >
      ...
      >
        {/* Back side */}
        <div className="absolute inset-0 w-full h-full backface-hidden rounded-lg shadow-lg bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center p-3">
          <img
            src="/growy_logo.svg"
            alt="Growy Logo"
